...
class Locators:
    ...
    def clickIcon(self):
        ...
        for idx in range(3):
            try:
                icon = Waits.checkExplicitWaits(self.driver,Locators.VOICE_CLICK_ICON,"Click",20)
                ...
                icon = Waits.checkExplicitWaits(self.driver,Locators.VOICE_CLICK_ICON,"Expanded",20,"",icon)
